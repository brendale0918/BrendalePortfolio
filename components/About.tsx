...
export default function About() {
  ...
  return (
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <h2 className={`text-5xl md:text-6xl font-extrabold mb-6 text-gradient ${baloo.className}`}>
              About Me
            </h2>

            <p className="text-lg md:text-xl mb-4 leading-relaxed">
              Hi! I'm <span className="text-[#ff6a00] font-semibold">Brendale De Leon</span>, an aspiring web developer passionate about building <span className="text-[#ff784e] font-medium">modern, responsive, and user-friendly web applications</span>. I love turning ideas into reality through clean and efficient code.
            </p>

            <p className="text-lg md:text-xl mb-4 leading-relaxed">
              I specialize in frontend development using <span className="text-[#ff6a00] font-medium">Next.js, React.js, and Tailwind CSS</span>, and continuously strive to improve my skills while staying up-to-date with the latest web trends.
            </p>

            <p className="text-lg md:text-xl leading-relaxed">
              Outside coding, I enjoy singing at church and exploring creative ways to combine <span className="text-[#ff784e] font-medium">design and functionality</span> in projects.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                      <div>
                        <h3 className={`text-3xl font-bold text-[#ff6a00] mb-2 ${baloo.className}`}>
                    ...
                    <ul className="list-disc list-inside space-y-3 text-gray-300 text-lg">
                      <li>
                        Executed <span className="text-white font-medium">Business Rules Testing Specifications</span> 
                        to verify system accuracy and alignment with requirements.
                      </li>
                      <li>
                        Performed <span className="text-white font-medium">manual testing</span> with documentation.
                      </li>
                      <li>
                        Reviewed and updated <span className="text-white font-medium">test documentation</span> 
                        to improve QA standards and practices.
                      </li>
                      <li>
                      ...
                      <li>
                        Assisted in verification of <span className="text-white font-medium">new features and updates</span>.
                      </li>
                    </ul>
                  </motion.div>
                  ...
                  >
                    <h3 className={`text-3xl font-bold text-[#ff6a00] mb-4 ${baloo.className}`}>
                      Academic Excellence
                    </h3>
                    <p className="text-lg text-gray-300 leading-relaxed">
                      ...
                      <span className="text-white"> dedication, discipline</span>, and passion for continuous learning 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-20 pb-24">
        <h3 className={`text-4xl font-bold text-center text-[#ff6a00] mb-12 ${baloo.className}`}>
      ...
      {selectedCert && (
        ...
        >
          ...
          >
            ...
            <h4 className="text-2xl font-bold text-[#ff6a00] mb-4">{selectedCert.title}</h4>
